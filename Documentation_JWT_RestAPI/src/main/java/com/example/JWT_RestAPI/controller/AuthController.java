...
public class AuthController {
    ...
    @GetMapping("/admin")
    public String onlyAdministrador(Authentication authentication) {
        return "Administrador: " + authentication.getName();
    }

    // Somente o moderador irá acessar
    @Secured("Moderador")
    @GetMapping("/moderado")
    public String onlyModerador(Authentication authentication) {
        return "Moderador: " + authentication.getName();
    }

    // Qualquer um irá acessar
    @GetMapping("/comum")
    public String onlyUsuarioComum(Authentication authentication) {
